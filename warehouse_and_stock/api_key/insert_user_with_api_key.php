...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Validate the data
    $validationRules = [
      'product_id' => ['required' => true, 'string' => true],
      'stock_level' => ['required' => true, 'integer' => true],
      'restock_threshold' => ['required' => true, 'integer' => true],
      'last_restock_date' => ['required' => true, 'date_format' => 'Y-m-d'],
      'warehouse_id' => ['required' => true, 'string' => true],
      'warehouse_type' => ['required' => true, 'string' => true],
      'warehouse_name' => ['required' => true, 'string' => true],
      'address' => ['required' => true, 'string' => true],
      'latitude' => ['required' => true, 'float' => true],
      'longitude' => ['required' => true, 'float' => true],
      'capacity' => ['required' => true, 'integer' => true],
      'current_stock_level' => ['required' => true, 'integer' => true],
      'creation_date' => ['required' => true, 'date_format' => 'Y-m-d'],
      'last_update' => ['required' => true, 'date_format' => 'Y-m-d'],
      'is_active' => ['required' => true, 'boolean' => true],
      'temperature_control' => ['required' => true, 'string' => true],
      'humidity_control' => ['required' => true, 'string' => true],
      'temperature_control_fridge' => ['required' => true, 'string' => true],
      'humidity_control_fridge' => ['required' => true, 'string' => true],
      'temperature_control_freezer' => ['required' => true, 'string' => true],
      'humidity_control_freezer' => ['required' => true, 'string' => true],
      'incident_log' => ['array' => true],
      'restock_lead_time' => ['required' => true, 'string' => true],
    ...
    $collection = $db->selectCollection("warehouse_and_stocks");
