...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $validationRules = [
      ...
      'link' => ['required' => true, 'string' => true],
      'main_image' => ['required' => true, 'string' => true],
      'description' => ['required' => true, 'string' => true],
      'ingredients' => ['array' => true],
      'utensils' => ['array' => true],
      'nutrition' => ['required' => true, 'string' => true],
      'tags' => ['array' => true],
      'steps' => ['array' => true],
      'categories' => ['array' => true],
      'difficulty' => ['required' => true, 'string' => true],
      'preparation_time' => ['required' => true, 'string' => true],
      'baking_time' => ['required' => true, 'string' => true],
      'resting_time' => ['required' => true, 'string' => true],
    ];
    ...
    $collection = $db->selectCollection("recipe");
